...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
            ...
            // textBox1
            // 
            this->textBox1->Location = System::Drawing::Point(764, 189);
            this->textBox1->Multiline = true;
            this->textBox1->Name = L"textBox1";
            this->textBox1->Size = System::Drawing::Size(315, 470);
...
#pragma endregion
    private: System::Void MyForm_Load(System::Object^ sender, System::EventArgs^ e) {
        ...
        arr_label = gcnew array<int, 2>(size, size)
        {
            ...
            { 103,118,128,138,148,158,168,178,188,189 },
        ...
        for (int i = 0;i < size;i++)
        {
            for (int j = 0;j < size;j++)
            {
                textBox1->Text += arr_poz_bomb[i, j];
            }
            textBox1->Text += "\r\n";
        }
    }
